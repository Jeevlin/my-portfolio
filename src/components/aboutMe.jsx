...
function AboutMe() {
  return (
    <section id="about" style={{ padding: '60px 20px', textAlign: 'center', backgroundColor: '#fefefe' }}>
      <h2>About Me</h2>
      ...
      <p style={{ fontStyle: 'italic', marginTop: '20px', color: '#555' }}>
        Fun fact: I debug best with a hot cup of coffee and soft music in the background ☕🎧
      </p>
    </section>
  );
}
